...
const experiences = [
    {
        ...
        logo: xurgeLogo,
        description: [
            "Developing and building 'Earn My Money', a reward-based earning platform at Xurge.",
        ...
        tech: ["Java", "Spring Boot", "WebFlux", "PostgreSQL", "Redis", "Kafka", "JWT"],
    },
    {
            ...
            <div className="relative border-l border-gray-800 pl-6 space-y-20">
                {experiences.map((exp, idx) => (
                    <div key={idx} className="relative group">
                        {/* Timeline Dot */}
                        <span
                            className="absolute -left-[14px] top-8 w-6 h-6 rounded-full bg-gradient-to-r from-indigo-500 to-pink-500 border-4 border-gray-950 shadow-md"></span>

                        {/* Card */}
                        <Card
                            className="rounded-2xl shadow-xl bg-gray-900 border border-gray-800 transition duration-300 hover:border-indigo-500 hover:shadow-lg hover:shadow-indigo-500/20">
